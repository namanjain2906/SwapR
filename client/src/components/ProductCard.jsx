...
const ProductCard = ({ ProductId, Image, Title, Price, Description }) => {
  ...
  return (
    <div
      ...
      className="group hover:-translate-y-0.5 flex justify-between flex-col w-full rounded-2xl my-4 max-md:text-base md:text-xl overflow-hidden object-contain p-3 md:pb-5 cursor-pointer"
    >
      <img
        src={Image}
        alt="Product Image"
        className="rounded-2xl object-center w-full h-56 md:h-70 object-cover"
      />
