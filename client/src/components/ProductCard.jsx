...
const ProductCard = ({ ProductId, Image, Title, Price, Description }) => {
  ...
  return (
    <div
      ...
      className="group hover:-translate-y-0.5 flex justify-between items-center max-md:m-1 max-md:mb-3 flex-col  md:w-80 md:h-100 max-md:w-50 max-md:h-90 bg-gray-800 rounded-2xl my-7 max-md:text-base md:text-xl overflow-hidden object-contain max-md:p-3 md:p-3 md:pb-5 cursor-pointer"
    >
      <img
        src={Image}
        alt="Product Image"
